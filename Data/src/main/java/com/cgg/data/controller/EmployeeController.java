...
public class EmployeeController {
	...
	public ResponseEntity<Employee> addEmployee(@RequestBody Employee employee) throws ServiceException {
	...
	public ResponseEntity<List<Employee>> getEmployeeList() throws ServiceException {
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable int id) throws ServiceException {
